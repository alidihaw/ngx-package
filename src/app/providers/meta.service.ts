...
export class MetaService {
    ...
    setMeta(payload: MetaModel) {
        ...
        this.meta.updateTag({ name: 'og:image', content: payload.image || 'https://storage.googleapis.com/bucket.maple.haus/assets/maple.svg' },);
        ...
        this.meta.updateTag({ name: 'twitter:image', content: payload.image || 'https://storage.googleapis.com/bucket.maple.haus/assets/maple.svg' },);
        ...
        this.meta.updateTag({ name: 'author', content: 'Maple', },);
